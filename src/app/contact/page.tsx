        ...
        <div className="container">
          <div className="contact-grid reveal">
            ...
            <div className="contact-card">
              ...
              <h4>No Spam, Ever</h4>
              <p>Your information is private. We only use it to respond to your inquiry.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="form-section reveal">
            <div>
              ...
              <p style={{ color: '#64748B', marginBottom: '2rem' }}>Fill out the form and we&rsquo;ll get back to you within 24 hours.</p>
              <ContactForm />
            </div>
            <div>
              <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: '16px', padding: '2rem' }}>
                ...
                <div style={{ marginBottom: '1.5rem' }}>
                  ...
                  <p style={{ fontSize: '0.875rem', color: '#64748B' }}>We respond to all inquiries within 24 hours. For urgent matters, mention it in the form and we&rsquo;ll prioritize your request.</p>
                </div>
                <div>
