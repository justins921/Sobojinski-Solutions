...
export const metadata: Metadata = {
  ...
  description: 'Purpose-built software platforms that solve real business problems. From healthcare to golf improvement, Sobojinski Solutions delivers the operating systems your business needs.',
  ...
  openGraph: {
    ...
    description: 'Purpose-built software platforms that solve real business problems across healthcare, golf improvement, workforce management, and digital marketing.',
    type: 'website',
